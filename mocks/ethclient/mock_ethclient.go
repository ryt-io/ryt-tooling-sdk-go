...
// Source: /Users/felipe.madero/go/pkg/mod/github.com/ava-labs/subnet-evm@v0.7.5/ethclient/ethclient.go
//
// Generated by this command:
//
//	mockgen -source=/Users/felipe.madero/go/pkg/mod/github.com/ava-labs/subnet-evm@v0.7.5/ethclient/ethclient.go -destination=avalanche-tooling-sdk-go/mocks/ethclient/mock_ethclient.go Client
//
...
func (m *MockClient) AcceptedCallContract(arg0 context.Context, arg1 libevm.CallMsg) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) CallContract(arg0 context.Context, arg1 libevm.CallMsg, arg2 *big.Int) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) CallContractAtHash(ctx context.Context, msg libevm.CallMsg, blockHash common.Hash) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) EstimateGas(arg0 context.Context, arg1 libevm.CallMsg) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*libevm.FeeHistory, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FeeHistory", ctx, blockCount, lastBlock, rewardPercentiles)
	ret0, _ := ret[0].(*libevm.FeeHistory)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) FilterLogs(arg0 context.Context, arg1 libevm.FilterQuery) ([]types.Log, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SubscribeFilterLogs(arg0 context.Context, arg1 libevm.FilterQuery, arg2 chan<- types.Log) (libevm.Subscription, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeFilterLogs", arg0, arg1, arg2)
	ret0, _ := ret[0].(libevm.Subscription)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) SubscribeNewAcceptedTransactions(arg0 context.Context, arg1 chan<- *common.Hash) (libevm.Subscription, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SubscribeNewHead(arg0 context.Context, arg1 chan<- *types.Header) (libevm.Subscription, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SubscribeNewPendingTransactions(arg0 context.Context, arg1 chan<- *common.Hash) (libevm.Subscription, error) {
	m.ctrl.T.Helper()
